...
INSERT INTO workout_exercises (workout_id, exercise_id, order_index, target_sets, target_reps, rest_seconds) VALUES
(1, 5, 1, 3, ARRAY[12, 12, 12], 90),  -- Squats
(1, 9, 2, 3, ARRAY[10, 10, 10], 60),  -- Push-ups
(1, 4, 3, 3, ARRAY[12, 12, 12], 90),  -- Dumbbell Rows
(1, 12, 4, 3, ARRAY[30, 30, 30], 60), -- Plank (seconds)
(1, 7, 5, 3, ARRAY[10, 10, 10], 90);  -- Lunges

-- Push Day (workout_id: 2)
INSERT INTO workout_exercises (workout_id, exercise_id, order_index, target_sets, target_reps, rest_seconds) VALUES
(2, 1, 1, 4, ARRAY[8, 8, 6, 6], 120),   -- Bench Press
(2, 3, 2, 4, ARRAY[10, 10, 8, 8], 90),  -- Overhead Press
(2, 9, 3, 3, ARRAY[12, 12, 12], 60),    -- Push-ups
(2, 4, 4, 3, ARRAY[12, 12, 12], 90);    -- Dumbbell Rows (for balance)

-- Pull Day (workout_id: 3)
INSERT INTO workout_exercises (workout_id, exercise_id, order_index, target_sets, target_reps, rest_seconds) VALUES
(3, 2, 1, 4, ARRAY[6, 6, 5, 5], 120),   -- Pull-ups
(3, 4, 2, 4, ARRAY[12, 12, 10, 10], 90), -- Dumbbell Rows
(3, 8, 3, 3, ARRAY[12, 12, 12], 90);    -- Romanian Deadlifts

-- Leg Day (workout_id: 4)
INSERT INTO workout_exercises (workout_id, exercise_id, order_index, target_sets, target_reps, rest_seconds) VALUES
(4, 5, 1, 4, ARRAY[12, 12, 10, 10], 120), -- Squats
(4, 6, 2, 4, ARRAY[8, 8, 6, 6], 150),     -- Deadlifts
(4, 7, 3, 3, ARRAY[12, 12, 12], 90),      -- Lunges
(4, 8, 4, 3, ARRAY[15, 15, 15], 90);      -- Romanian Deadlifts
...
(5, 10, 1, 4, NULL, 60, 30),  -- Burpees
(5, 11, 2, 4, NULL, 60, 30),  -- Mountain Climbers
(5, 15, 3, 4, NULL, 60, 30),  -- Jump Rope
(5, 9, 4, 4, ARRAY[15, 15, 15, 15], 60);  -- Push-ups

-- Core Blast (workout_id: 6)
INSERT INTO workout_exercises (workout_id, exercise_id, order_index, target_sets, target_reps, rest_seconds, target_duration_seconds) VALUES
(6, 12, 1, 3, NULL, 60, 45),   -- Plank
(6, 16, 2, 3, ARRAY[20, 20, 20], 45), -- Crunches
(6, 17, 3, 3, ARRAY[30, 30, 30], 45), -- Russian Twists
(6, 11, 4, 3, NULL, 45, 30);   -- Mountain Climbers