/*
  # Analytics and Performance Optimization (Final Fix)
  ...
  Note: Removed updated_at column reference that was causing errors
*/
...
-- Exercise Analytics (Removed updated_at column reference)
...
-- Indexes for Performance (Removed updated_at index reference)
...
CREATE INDEX IF NOT EXISTS idx_exercise_analytics_created_at ON exercise_analytics(created_at);
