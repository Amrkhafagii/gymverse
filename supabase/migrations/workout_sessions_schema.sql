/*
  # Workout Sessions & Exercise Tracking Schema
...
-- Add all constraints after all tables are created
DO $$
BEGIN
  ...
  -- Only add foreign key if both tables and columns exist
  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'exercises' AND column_name = 'category_id')
     AND EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'exercise_categories')
     AND NOT EXISTS (
       SELECT 1 FROM information_schema.table_constraints 
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'exercises' AND column_name = 'created_by')
     AND NOT EXISTS (
       SELECT 1 FROM information_schema.table_constraints 
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'workout_templates' AND column_name = 'user_id')
     AND NOT EXISTS (
       SELECT 1 FROM information_schema.table_constraints 
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'workout_sessions' AND column_name = 'user_id')
     AND NOT EXISTS (
       SELECT 1 FROM information_schema.table_constraints 
  ...
  -- Check if status column exists before adding constraint
  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'workout_sessions' AND column_name = 'status')
     AND NOT EXISTS (
       SELECT 1 FROM information_schema.table_constraints 
  ...
  -- Check if mood_rating column exists before adding constraint
  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'workout_sessions' AND column_name = 'mood_rating')
     AND NOT EXISTS (
       SELECT 1 FROM information_schema.table_constraints 
  ...
  -- Check if energy_level column exists before adding constraint
  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'workout_sessions' AND column_name = 'energy_level')
     AND NOT EXISTS (
       SELECT 1 FROM information_schema.table_constraints 
  ...
  -- Workout Exercises constraints - Check column existence first
  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'workout_exercises' AND column_name = 'workout_session_id')
     AND EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'workout_sessions')
     AND NOT EXISTS (
       SELECT 1 FROM information_schema.table_constraints 
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'workout_exercises' AND column_name = 'template_id')
     AND EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'workout_templates')
     AND NOT EXISTS (
       SELECT 1 FROM information_schema.table_constraints 
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'workout_exercises' AND column_name = 'exercise_id')
     AND EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'exercises')
     AND NOT EXISTS (
       SELECT 1 FROM information_schema.table_constraints 
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'workout_exercises' AND column_name = 'workout_session_id')
     AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'workout_exercises' AND column_name = 'template_id')
     AND NOT EXISTS (
       SELECT 1 FROM information_schema.table_constraints 
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'exercise_sets' AND column_name = 'workout_exercise_id')
     AND EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'workout_exercises')
     AND NOT EXISTS (
       SELECT 1 FROM information_schema.table_constraints 
  ...
  -- Check if rpe column exists before adding constraint
  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'exercise_sets' AND column_name = 'rpe')
     AND NOT EXISTS (
       SELECT 1 FROM information_schema.table_constraints 
...
-- Exercise Categories (public read, admin write)
DO $$
BEGIN
  IF NOT EXISTS (
