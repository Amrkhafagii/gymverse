/*
  # Achievement System Final Migration (Criteria Column Fixed)
  ...
  Note: Includes name, title, and criteria columns for achievements table
*/
...
-- Wait for categories to be inserted, then add achievements with name, title, and criteria
DO $$
BEGIN
...
-- Update existing achievements with default criteria if null
UPDATE achievements SET criteria = COALESCE(description, 'Achievement criteria') WHERE criteria IS NULL;
